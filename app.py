...
def main():
    ...
    def upload_page():
        st.markdown("<br>", unsafe_allow_html=True)
        st.image("XS.png")
        st.markdown("**Unable to Type? Use Our [ASR-AROGYA-SHREE(Speech-to-Text Service)](https://huggingface.co/spaces/Shree2604/ASR-AROGYA-SHREE)**")
        ...
        if st.sidebar.button("Send"):
            if interaction_type == "PDF" and uploaded_file_pdf is not None and user_question:
                ...
                # Display user's question with styling and emoji
                st.write("<div style='background-color: #31333f; padding: 6px; border-radius: 10px;'>👤 You: {}</div>".format(prompt), unsafe_allow_html=True)
                ...
                if user_question:
                  ...
                  # Display chatbot's answer with styling and emoji
    ...
    def tasks_page():
        ...
        st.image("n.png")
        st.markdown("<br>", unsafe_allow_html=True)
        st.header(":mailbox: Drop A Comment")
        contact_form = """
        <form action="https://formsubmit.co/shreeraj260504@gmail.com" method="POST">
    ...
    # Display the page selection menu
    selected_page = option_menu(None, ["Home", "Info", "ChatBot", 'FeedBack'], 
                            icons=['house', 'info', "robot", 'pen'],
